...
starting_fuel_level=int(input("What is the starting fuel level?"))

while starting_fuel_level<5000 or starting_fuel_level>30000:
  starting_fuel_level=input("Please state the appropriate fuel level.")
...
while starting_fuel_level>0:
  ...
  altitude_shuttle+=50
  print("The shuttle gained an altitude of", altitude_shuttle, "km and has", starting_fuel_level,"kg of fuel left.")

if altitude_shuttle>=2000:
